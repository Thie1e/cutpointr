---
title: "Introduction to cutpointr"
author: "Christian Thiele"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to cutpointr}
...
If `method` is `maximize_metric` or `minimize_metric` the metric over all 
possible cutoff values can be plotted using `plot_metric`:
