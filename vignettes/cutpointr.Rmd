...
Additional metrics, e.g. Cohen's Kappa, PPV, NPV and so on, can be added to the
ROC curve via `add_metric`. 
...
used to achieve the same result. It maps multiple predictor columns to 
`cutpointr_`, by default all columns except for the class column.
...
results <- structure(list(time = c(4.4290145, 2.076954, 0.969923, 41.3452605, 
37.6318835, 6.672219, 6.408562, 3546.0633985, 4.8078475, 3415.179475, 
28.4640365, 55.908961, 48.733272, 307.2758195, 748.0846365, 737.162376, 
5618.6891055, 11050.6742895, 11127.924753), solution = c("cutpointr", 
...
"pROC"), n = c(1000, 1000, 1000, 1000, 1000, 10000, 10000, 10000, 
10000, 10000, 1e+05, 1e+05, 1e+05, 1e+06, 1e+06, 1e+06, 1e+07, 
1e+07, 1e+07)), row.names = c(NA, -19L), class = "data.frame")
```
...
results <- structure(list(time = c(0.8369425, 2.009407, 0.8077945, 1.965323, 
6.2294905, 4.5425065, 12.986888, 54.6753075, 45.2200015, 179.604702, 
745.745925, 679.536119, 2738.7512405, 10340.7540995, 10021.4714795
), solution = c("cutpointr", "ROCR", "pROC", "cutpointr", "ROCR", 
"pROC", "cutpointr", "ROCR", "pROC", "cutpointr", "ROCR", "pROC", 
"cutpointr", "ROCR", "pROC"), n = c(1000, 1000, 1000, 10000, 
10000, 10000, 1e+05, 1e+05, 1e+05, 1e+06, 1e+06, 1e+06, 1e+07, 
1e+07, 1e+07)), row.names = c(NA, -15L), class = "data.frame")
